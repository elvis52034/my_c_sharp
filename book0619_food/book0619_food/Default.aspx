<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="book0619_food.Default" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="編號" DataSourceID="SqlDataSource1" DefaultMode="Insert" Height="50px" OnItemInserting="DetailsView1_ItemInserting" OnPageIndexChanging="DetailsView1_PageIndexChanging">
        ...
        <br />
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="編號" DataSourceID="SqlDataSource1" OnRowDeleting="GridView1_RowDeleting" OnRowUpdating="GridView1_RowUpdating" PageSize="5">
            <Columns>
                ...
                <asp:TemplateField HeaderText="類別" SortExpression="類別">
                    <EditItemTemplate>
                        <asp:DropDownList ID="DropDownList2" runat="server" SelectedValue='<%# Bind("類別") %>'>
                            ...
                            <asp:ListItem>日式料理</asp:ListItem>
                            <asp:ListItem>泰式料理</asp:ListItem>
                            <asp:ListItem Value="火鍋類"></asp:ListItem>
                            <asp:ListItem>燒烤類</asp:ListItem>
                            <asp:ListItem>排餐類</asp:ListItem>
                            <asp:ListItem>小吃類</asp:ListItem>
                            <asp:ListItem>主題餐廳</asp:ListItem>
                ...
                <asp:TemplateField HeaderText="圖示" SortExpression="圖示">
                    ...
                    <ItemTemplate>
                        <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("圖示","images/{0}") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="電話" HeaderText="電話" SortExpression="電話" />
                <asp:BoundField DataField="地址" HeaderText="地址" SortExpression="地址" />
